...
from transformers import AutoTokenizer #JLK
import pickle
...
class DeepECDataset(Dataset):
    def __init__(self, data_X, data_Y, explainECs, tokenizer_name='Rostlab/prot_bert_bfd', max_length=1000, pred=False):
       # with open('/home/smallikao/DeepProZyme/deepec/tokenizer.pkl', 'rb') as f: #JLK
           # self.tokenizer = pickle.load(f) #JLK
       # self.tokenizer = AutoTokenizer.from_pretrained(tokenizer_name, do_lower_case=False)
        self.tokenizer = AutoTokenizer.from_pretrained('/home/smallikao/DeepProZyme/prot_bert_bfd_tokenizer')
